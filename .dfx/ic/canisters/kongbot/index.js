...
import { idlFactory } from './kongbot.did.js';
export { idlFactory } from './kongbot.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_KONGBOT;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./kongbot.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the kongbot canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./kongbot.did.js")._SERVICE>}
 */
export const kongbot = createActor(canisterId);
